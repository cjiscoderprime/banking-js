...
const AuthForm = ({ type }: { type: string }) => {
    ...
    return (
        <section className = "auth-form">
            ...
            alt = "Divus logo" 
            />
            <h1 className = "text-26 font-ibm-plex-serif font-bold text-black-1">Divus</h1>
            </Link>
                    ...
                    className = "space-y-8">
                        {type === 'sign-up' && (
                            ...
                            control = {form.control} name = "lastName" label = "Last Name" placeholder = "Enter your Last Name"/>
                             ...
                             <CustomInput
                                control = {form.control} name = "address1" label = "Address" placeholder = "Enter your main address"/>
                            ...
                            <div className = "flex gap-4">
                             <CustomInput
                            control = {form.control} name = "state" label = "State" placeholder = "Example: PA"/>

                             <CustomInput
                            control = {form.control} name = "postalCode" label = "Postal Code" placeholder = 'Example: 11101' />
                            </div>
